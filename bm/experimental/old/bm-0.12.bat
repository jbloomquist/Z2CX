...
::ECHO %address% | FINDSTR "://*" >nul && SET "url=1" && echo url %url% -------------------[OLD METHOD REMOVE AFTER DEBUGGING]
...
IF DEFINED url IF "%~2" NEQ "" SET "address=%address%%~2"
